...
void AudioCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->audioFrameReady((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 2: _t->captureLoop(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AudioCapture::*)(const QString & )>(_a, &AudioCapture::logMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioCapture::*)(QByteArray )>(_a, &AudioCapture::audioFrameReady, 1))
            return;
    }
}
...
// SIGNAL 0
void AudioCapture::logMessage(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void AudioCapture::audioFrameReady(QByteArray _t1)
{
